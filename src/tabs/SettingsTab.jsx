          ...
          <label style={{ flexShrink:0, cursor:'pointer' }}>
            <div style={{
              ...
              {gs.avatarUrl
                ...
                : <span style={{ fontFamily:'var(--font-display)', fontSize:20, color: genre?.color || 'var(--text-muted)' }}>{(gs.stageName||'?')[0]}</span>
              }
              ...
              >
                <span style={{ fontSize:9, color:'#fff', fontWeight:700 }}>EDIT</span>
              </div>
            </div>
