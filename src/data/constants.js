...
export const CAREER_TYPES = [
  {
    ...
    stats:{ sw:36, vc:28, pd:20, lp:32, hustle:12, charisma:6, network:4 },
  ...
  },
  {
    ...
    stats:{ sw:16, vc:24, pd:12, lp:20, hustle:7, charisma:13, network:10 },
  ...
  },
  {
    ...
    stats:{ sw:12, vc:16, pd:8, lp:8, hustle:3, charisma:8, network:7 },
  ...
  },
  {
    ...
    stats:{ sw:28, vc:36, pd:20, lp:40, hustle:5, charisma:9, network:9 },
  ...
  },
  {
    ...
    stats:{ sw:40, vc:12, pd:64, lp:8, hustle:8, charisma:5, network:8 },
    perk:'Production starts at 64. Songs 30% cheaper.',
    se:7,
  },
];
...
// ─── JOBS ─────────────────────────────────────────────────────────────────────
// weeklyPay: income per week (not instant)
// duration: how many weeks the job lasts
// energyPerWeek: energy cost each week the job is active
// skillGain: optional skill bonus when job starts
// req: requirement to unlock (e.g. 'sw20', 'fans5000')
// illegal: true = risk of arrest each week (prisonRisk = chance 0–1)
export const JOBS = [
  // ── LEGAL ──────────────────────────────────────────────────────────────────
  { id:'teach',       label:'Give Music Lessons',    weeklyPay:45000,   duration:3,  energyPerWeek:8,  skillGain:{sw:1},  req:null,          desc:'Teach local kids. Consistent but low-key.',         illegal:false },
  { id:'dj_set',      label:'DJ at Local Venue',     weeklyPay:90000,   duration:2,  energyPerWeek:12, skillGain:{lp:1},  req:null,          desc:'Spin records on weekends. Builds presence.',       illegal:false },
  { id:'studio_asst', label:'Studio Assistant',      weeklyPay:120000,  duration:4,  energyPerWeek:12, skillGain:{pd:1},  req:null,          desc:'Learn the board assisting bigger sessions.',       illegal:false },
  { id:'session',     label:'Session Musician',      weeklyPay:250000,  duration:3,  energyPerWeek:18, skillGain:{vc:1},  req:'vc20',        desc:'Play on someone else\'s record.',                   illegal:false },
  { id:'jingle',      label:'Write Jingles',         weeklyPay:400000,  duration:3,  energyPerWeek:15, skillGain:{sw:1},  req:'sw20',        desc:'Commercial work. Steady creative bread.',          illegal:false },
  { id:'ambassador',  label:'Brand Ambassador',      weeklyPay:500000,  duration:4,  energyPerWeek:8,  skillGain:null,    req:'fans5000',    desc:'Represent a local brand on socials.',              illegal:false },
  { id:'ghost_write', label:'Ghost Write Hit',       weeklyPay:1200000, duration:2,  energyPerWeek:25, skillGain:{sw:2},  req:'sw40',        desc:'Write a banger for someone else. No credit.',      illegal:false },
  { id:'headline_gig',label:'Headline Local Show',   weeklyPay:800000,  duration:2,  energyPerWeek:20, skillGain:{lp:2},  req:'fans1000',    desc:'Headline a real venue. Fans show up.',             illegal:false },
  { id:'beatmaker',   label:'Sell Beats Online',     weeklyPay:300000,  duration:4,  energyPerWeek:10, skillGain:{pd:1},  req:'pd25',        desc:'Drop packs online. Passive-ish income.',           illegal:false },
  { id:'radio_host',  label:'Radio Show Host',       weeklyPay:650000,  duration:6,  energyPerWeek:15, skillGain:null,    req:'fans10000',   desc:'Host a weekly segment. Industry connections.',     illegal:false },
  // ── ILLEGAL ─────────────────────────────────────────────────────────────────
  { id:'bootleg',     label:'Bootleg CD Hustle',     weeklyPay:200000,  duration:3,  energyPerWeek:10, skillGain:null,    req:null,          desc:'Flip pirated music on the street.',                illegal:true,  prisonRisk:0.08,  prisonWeeks:2  },
  { id:'promo_scam',  label:'Fake Promo Scam',       weeklyPay:800000,  duration:2,  energyPerWeek:5,  skillGain:null,    req:null,          desc:'Charge artists for fake playlist placements.',     illegal:true,  prisonRisk:0.12,  prisonWeeks:3  },
  { id:'money_laund', label:'Money Laundering Front',weeklyPay:3000000, duration:4,  energyPerWeek:8,  skillGain:null,    req:'fans2000',    desc:'Use your music career as a front. Massive risk.',  illegal:true,  prisonRisk:0.20,  prisonWeeks:8  },
  { id:'gang_ties',   label:'Street Enforcer',       weeklyPay:1500000, duration:3,  energyPerWeek:15, skillGain:null,    req:null,          desc:'Run errands for dangerous people. High stakes.',   illegal:true,  prisonRisk:0.18,  prisonWeeks:6  },
  { id:'drug_run',    label:'Shady Distribution',    weeklyPay:5000000, duration:2,  energyPerWeek:20, skillGain:null,    req:null,          desc:'One run. Never talk about it.',                    illegal:true,  prisonRisk:0.30,  prisonWeeks:12 },
];
