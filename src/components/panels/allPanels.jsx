...
const ACTIONS = [
  ...
  { id:'promote',      icon:'📢',  label:'Promo Campaign',        desc:'Push ad spend to boost your latest release's streams.',       tip:'Costs money',           cat:'market',  grad:'from-orange-600 to-red-600' },
